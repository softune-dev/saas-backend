...
Do not remove any of the three while DATABASE_URL points at port 6543. (On the
direct port-5432 URL you own a real dedicated connection and none are needed.)
"""
